...
export default function PrivacyPage() {
  ...
  const SECTIONS = [
    ...
    // 법률 검토 필요: 개인정보 보호책임자(CPO) 실명·직책은 지정 후 실제 정보로 교체할 것
    { title: "9. 개인정보 보호책임자 및 문의", text: "개인정보 보호책임자: KoriBridge 운영팀 (문의 이메일: brian8542@gmail.com). 개인정보 관련 문의, 열람·정정·삭제 요청은 위 이메일 또는 서비스 내 신고 기능으로 연락해 주세요. 회사는 지체 없이 답변·처리합니다. 기타 신고·상담은 개인정보침해신고센터(privacy.kisa.or.kr, 국번 없이 118)에 문의할 수 있습니다." },
