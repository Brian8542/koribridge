    ...
    <div className="grid grid-cols-3 gap-3">
      <div className="bg-white rounded-xl border border-neutral-150 shadow-xs p-4 text-center">
        <div className="flex items-center justify-center gap-1.5 mb-1">
          ...
          <p className="text-2xs font-semibold uppercase tracking-widest text-neutral-400">{t.statsBannerOnline}</p>
        </div>
        <p className="text-xl font-bold text-emerald-600">{onlineCount}</p>
      </div>
      <div className="bg-white rounded-xl border border-neutral-150 shadow-xs p-4 text-center">
        <p className="text-2xs font-semibold uppercase tracking-widest text-neutral-400 mb-1">{t.statsBannerTotal}</p>
        <p className="text-xl font-bold text-neutral-900">{total}</p>
      </div>
      <div className="bg-white rounded-xl border border-neutral-150 shadow-xs p-4 text-center">
        <p className="text-2xs font-semibold uppercase tracking-widest text-neutral-400 mb-1">{t.statsBannerToday}</p>
